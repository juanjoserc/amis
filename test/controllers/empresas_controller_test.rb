...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { codigo: @empresa.codigo, nombre: @empresa.nombre, razon_social: @empresa.razon_social, status: @empresa.status }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { codigo: @empresa.codigo, nombre: @empresa.nombre, razon_social: @empresa.razon_social, status: @empresa.status }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
